  ...
  return (
    <main className="min-h-[317px] md:min-h-[414px] h-full lg:min-h-[700px] lg:px-36 md:px-20 pb-20 px-10 pt-9 md:pt-[60px] bg-[#f5f5f5]">
      ...
      <div className="flex flex-col gap-5 lg:gap-16 items-center md:items-center justify-between">
        <p className="text-xs leading-5 lg:pl-20 xl:pl-32 text-center md:text-base lg:text-2xl text-dark-grey font-light lg:text-left lg:pr-24">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 pt-20 mx-auto justify-start gap-x-5 gap-y-14">
